...
const Features = () => {
  return (
    <section className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,hsl(193_100%_50%/0.1),transparent_50%)]"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,hsl(270_70%_65%/0.1),transparent_50%)]"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold">
            Unique Features for
            <br />
            <span className="bg-gradient-primary bg-clip-text text-transparent">Deeper Understanding</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className={`bg-gradient-to-br ${feature.gradient} border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-glow-primary group cursor-pointer`}
              >
